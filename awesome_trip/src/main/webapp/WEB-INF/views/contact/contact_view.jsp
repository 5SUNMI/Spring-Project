...
<script>
	$(function() {
		$("#btnUpdate").click(function() {
			...
			if (confirm("수정하시겠습니까")) {
				document.form1.action = "${path}/contact/contact_update";
				document.form1.submit();
			}
		});
		$("#btnDelete").click(function() {
			if (confirm("삭제하시겠습니까")) {
				document.form1.action = "${path}/contact/contact_delete";
				document.form1.submit();
			}
		});
	});
...
<div class="container">
	...
	<form id="form1" name="form1" method="post">
		...
		<div class="row">
			<div class="form-group">
				<label>제목</label>
				<input type="text" name="title" value="${dto.title }" id="title" class="form-control" size="160" >
			</div>
		</div>
		<div class="row">
			<div class="form-group">
...
<script>
	...
	$("#btnList").on("click", function(e){
		...
		form.attr("action", "${path}/contact/contact_list");
		form.submit();
	});
</script>
</body>
