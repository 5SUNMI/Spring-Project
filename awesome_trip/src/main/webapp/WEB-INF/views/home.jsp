...
<style>
  ...
  .carousel-inner {
    ...
    height: 220px;
    margin: auto;
    overflow: hidden; /* Ensure that the container clips overflowing content */
  }

  /* Adjust the size and positioning of the images inside the carousel */
  .carousel-inner img {
			...
			<div id="carousel-generic" class="carousel slide">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="${path}/resources/imgs/main1.jpg" alt="First slide" />
						<div class="carousel-caption"></div>
					</div>
					<div class="item">
						<img src="${path}/resources/imgs/main1.jpg" alt="Second slide" />
						<div class="carousel-caption"></div>
					</div>
					<div class="item">
						<img src="${path}/resources/imgs/main1.jpg" alt="Third slide" />
						<div class="carousel-caption"></div>
					</div>
				</div>
				<!-- Controls -->
